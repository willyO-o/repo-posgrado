...
CASO: PASTELERÍA VICTORIA’S', 2, 21, 1, 4, 1, 222, '-', 'registrado', 22, 4.89, '60c224126500c.pdf', '60c224126500c', 'M55', 'SI');
...
EDUCATIVOS', 4, 6, 2, 3, 1, 199, '-', 'registrado', 21, 5.64, '60c2201f640ef.pdf', '60c2201f640ef', 'M001', 'SI');
...
A RECURSOS Y SERVICIOS QUE BRINDA LA CIUDAD DE EL ALTO', 3, 20, 1, 1, 1, 234, '-', 'registrado', 13, 7.04, '60c22dc2d9532.pdf', '60c22dc2d9532', 'M99', 'SI');
...
CONTROL DE INVENTARIOS DE EQUIPOS INFORMÁTICOS', 2, 18, 1, 2, 1, 155, '-', 'registrado', 2, 2.49, '60c22e0d71e4b.pdf', '60c22e0d71e4b', '-', 'SI');
...
-- ----------------------------
INSERT INTO "public"."srp_especialidades" VALUES (10, 'DIPLOMADO EN EDUCACIÓN SUPERIOR BASADO EN EL MODELO ACADÉMICO POR COMPETENCIAS');
INSERT INTO "public"."srp_especialidades" VALUES (1, 'DIPLOMADO EN DOCENCIA Y GESTIÓN DE AULA EN EDUCACIÓN SUPERIOR');
INSERT INTO "public"."srp_especialidades" VALUES (13, 'MAESTRÍA EN ADMINISTRACIÓN Y GESTIÓN EDUCATIVA');
INSERT INTO "public"."srp_especialidades" VALUES (2, 'MAESTRÍA EN DERECHO CONSTITUCIONAL Y DERECHO PROCESAL');
INSERT INTO "public"."srp_especialidades" VALUES (14, 'MAESTRÍA EN CIENCIAS PENALES Y CRIMINOLOGIA');
INSERT INTO "public"."srp_especialidades" VALUES (15, 'DIPLOMADO EN DERECHO PROCESAL PENAL MENCIÓN: LEY 1173');
INSERT INTO "public"."srp_especialidades" VALUES (16, 'MAESTRÍA EN EDUCACIÓN SUPERIOR POR COMPETENCIAS ');
INSERT INTO "public"."srp_especialidades" VALUES (17, 'DIPLOMADO EN DIRECCIÓN Y GESTIÓN DE CENTROS INFANTILES');
INSERT INTO "public"."srp_especialidades" VALUES (18, 'DIPLOMADO EN INVESTIGACIÓN CIENTÍFICA APLICADA A LA ADMINISTRACIÓN');
INSERT INTO "public"."srp_especialidades" VALUES (19, 'DIPLOMADO EN INVESTIGACIÓN CUALITATIVA ');
INSERT INTO "public"."srp_especialidades" VALUES (20, 'DIPLOMADO EN DESARROLLO DEL ESPÍRITU EMPRENDEDOR');
INSERT INTO "public"."srp_especialidades" VALUES (21, 'DIPLOMADO EN COMPETENCIAS DIGITALES Y HERRAMIENTAS DE LAS TIC S EN ADMINISTRACIÓN EMPRESARIAL');
INSERT INTO "public"."srp_especialidades" VALUES (22, 'DOCTORADO EN CIENCIA Y TECNOLOGÍA');
INSERT INTO "public"."srp_especialidades" VALUES (23, 'DOCTORADO EN CIENCIAS DE LA EDUCACIÓN E INVESTIGACIÓN');
INSERT INTO "public"."srp_especialidades" VALUES (24, 'DIPLOMADO EN POLÍTICA FISCAL Y TRIBUTARIA');
INSERT INTO "public"."srp_especialidades" VALUES (25, 'DIPLOMADO EN DERECHOS REALES, DERECHO NOTARIAL Y REGISTRAL');
INSERT INTO "public"."srp_especialidades" VALUES (29, 'ESPECIALIDAD 10');
...
ALTER TABLE "public"."srp_documentos" ADD CONSTRAINT "srp_documentos_id_sede_fkey" FOREIGN KEY ("id_sede") REFERENCES "public"."srp_sedes" ("id_sede") ON DELETE NO ACTION ON UPDATE CASCADE;
...
-- ----------------------------
ALTER TABLE "public"."ver_esp" ADD CONSTRAINT "ver_esp_id_especialidad_fkey" FOREIGN KEY ("id_especialidad") REFERENCES "public"."srp_especialidades" ("id_especialidad") ON DELETE CASCADE ON UPDATE CASCADE;
