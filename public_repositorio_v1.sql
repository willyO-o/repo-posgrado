...
BIBLIOTECAS', 1, 40, 14, 2, 'La Paz - El Alto', ': LIC. FREDDY SALGUEIRO TRUJILLO', 1);
...
DE VENTAS', 2, 34, 10, 1, 'La Paz - El Alto', '', 1);
...
CASO: PASTELERÍA VICTORIA’S', 2, 36, 21, 1, 'La Paz - El Alto', 'ING. ROLANDO ALARCON CHOQUEHUANCA', 1);
...
EDUCATIVOS', 4, 33, 6, 2, 'La Paz - El Alto', 'ING. SERGIO RAMIRO ROJAS SAIRE', 1);
...
EL ALTO', 1, 41, 16, 2, 'La Paz - El Alto', 'ING. MARICEL YARARI MAMANI ', 1);
...
PRODUCTOS CONGELADOS', 1, 42, 23, 3, 'La Paz - El Alto', 'M. SC. JUAN MARCOS MIRANDA NINA', 1);
...
ALMACENES', 1, 43, 10, 3, 'La Paz - El Alto', 'LIC. MARIO TORREZ CUPITICONA', 1);
...
CHATBOT (LUCIA SYSTEM)', 1, 44, 22, 3, 'Cochabamba', 'ING. ELíAS CARLOS HIDALGO MAMANI', 1);
...
DE ASOCIADOS', 2, 45, 20, 1, 'La Paz - El Alto', '', 1);
...
DE INVENTARIO EN ALMACÉN', 2, 46, 25, 1, 'La Paz - El Alto', '', 1);
...
A RECURSOS Y SERVICIOS QUE BRINDA LA CIUDAD DE EL ALTO', 3, 47, 20, 1, 'Cochabamba', 'LIC. FREDDY SALGUEIRO TRUJILLO', 1);
...
CONTROL DE INVENTARIOS DE EQUIPOS INFORMÁTICOS', 2, 48, 18, 1, 'Cochabamba', '', 1);
...
RESPECTO A EXÁMENES RADIOLÓGICOS', 4, 51, 14, 2, 'La Paz - El Alto', 'ING. MARISOL ARGUEDAS BALLADARES ', 1);
...
CIUDAD DE EL ALTO EN BASE A ALGORITMOS GENÉTICOS', 1, 52, 6, 2, 'La Paz - El Alto', 'M. SC. ING. ENRIQUE FLORES BALTAZAR', 1);
...
DE INTERMEDIACIÓN FINANCIERA EN BOLIVIA|', 1, 53, 23, 3, 'La Paz - El Alto', 'PH.D. GIMMY NARDO SANJINéS TUDELA', 1);
...
HUMANO', 1, 54, 13, 2, 'La Paz - El Alto', 'M. SC. MARISOL ARGUEDAS BALLADARES', 1);
