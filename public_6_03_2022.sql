...
-- ----------------------------
-- Sequence structure for ubicaciones_id_ubicacion_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "public"."ubicaciones_id_ubicacion_seq";
...
INSERT INTO "public"."archivos" VALUES (58, 'DOCUMENTO', 0.43, 'PDF', '60e117b49ded5.pdf', '60e117b49ded5');
...
');
INSERT INTO "public"."especialidades" VALUES (30, 'NUEVA ESPECIALIDAD');
...
TELEFONÍA MÓVIL CON TRANSMISIÓN SATELITAL', 2, 31, 24, 1, 'La Paz - El Alto', ': M. SC. JUAN MARCOS MIRANDA NINA', 1, NULL);
...
BIBLIOTECAS', 1, 40, 14, 2, 'La Paz - El Alto', ': LIC. FREDDY SALGUEIRO TRUJILLO', 1, NULL);
...
DE VENTAS', 2, 34, 10, 1, 'La Paz - El Alto', '', 1, NULL);
...
MEDICAMENTOS Y SERVICIOS COMPLEMENTARIOS', 2, 35, 17, 1, 'La Paz - El Alto', '', 1, NULL);
...
TRATAMIENTOS MÉDICOS PARA ÁREA DE IMAGENEOLOGIA', 1, 29, 17, 2, 'Cochabamba', ' ING. YULY RAMIREZ LIMACHI', 1, NULL);
...
CASO: PASTELERÍA VICTORIA’S', 2, 36, 21, 1, 'La Paz - El Alto', 'ING. ROLANDO ALARCON CHOQUEHUANCA', 1, NULL);
...
ADMINISTRATIVO', 1, 28, 22, 3, 'La Paz - El Alto', 'LIC. FREDDY SALGUEIRO TRUJILLO', 1, NULL);
...
proyecto.', 'ES', 'SISTEMA WEB DE INFORMACION ACADEMICA Y CHAT ONLINE', 2, 30, 23, 3, 'La Paz - El Alto', 'LIC. MARIA MAGDALENA AGUILAR GUANTO ', 1, NULL);
...
EDUCATIVOS', 4, 33, 6, 2, 'La Paz - El Alto', 'ING. SERGIO RAMIRO ROJAS SAIRE', 1, NULL);
...
FIJOS', 2, 37, 21, 1, 'Cochabamba', '', 1, NULL);
...
EL ALTO', 1, 41, 16, 2, 'La Paz - El Alto', 'ING. MARICEL YARARI MAMANI ', 1, NULL);
...
PRODUCTOS CONGELADOS', 1, 42, 23, 3, 'La Paz - El Alto', 'M. SC. JUAN MARCOS MIRANDA NINA', 1, NULL);
...
ALMACENES', 1, 43, 10, 3, 'La Paz - El Alto', 'LIC. MARIO TORREZ CUPITICONA', 1, NULL);
...
CHATBOT (LUCIA SYSTEM)', 1, 44, 22, 3, 'Cochabamba', 'ING. ELíAS CARLOS HIDALGO MAMANI', 1, NULL);
...
DE ASOCIADOS', 2, 45, 20, 1, 'La Paz - El Alto', '', 1, NULL);
...
DE INVENTARIO EN ALMACÉN', 2, 46, 25, 1, 'La Paz - El Alto', '', 1, NULL);
...
A RECURSOS Y SERVICIOS QUE BRINDA LA CIUDAD DE EL ALTO', 3, 47, 20, 1, 'Cochabamba', 'LIC. FREDDY SALGUEIRO TRUJILLO', 1, NULL);
...
CONTROL DE INVENTARIOS DE EQUIPOS INFORMÁTICOS', 2, 48, 18, 1, 'Cochabamba', '', 1, NULL);
...
DE CRÉDITOS', 1, 49, 6, 2, 'La Paz - El Alto', 'ING. MARISOL ARGUEDAS BALLADARES', 1, NULL);
...
RESPECTO A EXÁMENES RADIOLÓGICOS', 4, 51, 14, 2, 'La Paz - El Alto', 'ING. MARISOL ARGUEDAS BALLADARES ', 1, NULL);
...
CIUDAD DE EL ALTO EN BASE A ALGORITMOS GENÉTICOS', 1, 52, 6, 2, 'La Paz - El Alto', 'M. SC. ING. ENRIQUE FLORES BALTAZAR', 1, NULL);
...
DE INTERMEDIACIÓN FINANCIERA EN BOLIVIA|', 1, 53, 23, 3, 'La Paz - El Alto', 'PH.D. GIMMY NARDO SANJINéS TUDELA', 1, NULL);
...
HUMANO', 1, 54, 13, 2, 'La Paz - El Alto', 'M. SC. MARISOL ARGUEDAS BALLADARES', 1, NULL);
...
SOBRE ÍNDICES DE DESERCIÓN DE ALUMNOS', 2, 55, 21, 1, 'La Paz - El Alto', '', 1, NULL);
...
HERRAMIENTA DE ENSEÑANAZA EDITADO', 1, 50, 1, 3, 'La Paz - El Alto', 'LIC. ROBERTO DAVID MAYTA ALIGA', 1, NULL);
...
PLATAFORMA DE INTERNET DE LAS COSAS ', 1, 57, 6, 2, 'La Paz - El Alto', 'LIC. KATYA MARICELA PéREZ MARTíNEZ ', 11, NULL);
INSERT INTO "public"."metadatos" VALUES (57, 'SINDY ARAMAYO TORRICO', '2021-07-04', 2020, 'La clasificación es un proceso técnico archivístico relevante en la organización de los
documentos, por cuanto constituye la estructura organizativa de un archivo,
agrupando los documentos por fondo, sección, subsección y por serie, teniendo en
cuenta el principio de procedencia.
El grupo Iberoamericano de Tratamiento de Archivos Administrativos define
clasificación como:
‘’Técnica de identificación y agrupamiento sistemático de documentos semejantes,
según características comunes .Incluye un proceso de organización de un archivo, o
un sistema de archivos de acuerdo con un método de archivación previamente
adoptado.
La clasificación constituye columna vertebral de los procesos de Administración de
Documentos, ya que es un componente de control de la información archivística, que
consiste en la elaboración de un cuadro de clasificación, basados en criterios de
estructura orgánica, cronológicos, geográficos, temáticos, alfabéticos u otros, para
facilitar el manejo y uso de los documentos”. Para la clasificación se deben conocer
los siguientes términos:
• Fondo: conjunto de documentos producidos por una entidad.
• Sección: divisiones del fondo, son las funciones que desempeñan las
diferentes unidades administrativas.
• Serie documental: conjunto de documentos que versan sobre un mismo
asunto, generalmente son de un mismo tipo documental, es decir, por
categorías documentales.
Las cuales pueden estar compuestas por unidades simples o complejas, simples
como las resoluciones y compuestas como los contratos y/o nombramientos de
docentes y/o estudiantes. Unidad documental: es la unidad archivística más
pequeña.
Por lo que clasificar es agrupar los documentos dentro del mismo concepto tomando
en cuenta la estructura jerárquica y lógica de la unidad.
En ese sentido es esencial determinar la serie que responda a una actividad para sí
indicar que los documentos pertenezcan al mismo asunto', 'ES', 'ORGANIZACIÓN Y CLASIFICACIÓN DOCUMENTAL DE ARCHIVOS DE
OFICINA EN LA CARRERA DE INGENIERÍA DE SISTEMAS DE LA
UNIVERSIDAD PÚBLICA DE EL ALTO
', 2, 58, 1, 1, 'La Paz - El Alto', '', 1, NULL);
...
CREATE TABLE "public"."ubicaciones" (
  "id_ubicacion" int4 NOT NULL DEFAULT nextval('ubicaciones_id_ubicacion_seq'::regclass),
  "ubicacion" varchar(250) COLLATE "pg_catalog"."default" NOT NULL,
...
INSERT INTO "public"."usuarios" VALUES (13, 'PRUEBA2', '$2y$10$Hk2rF9Oo7LBV1Kh4dgHEj.cAd2nPXFvf2YXYaApY2W4eL.s2e9Tj2', 'PRUEBA2', 'PRUEBA2', 'f', 2);
...
INSERT INTO "public"."ver_esp" VALUES (30, 19, 30);
...
INSERT INTO "public"."versiones" VALUES (19, 'VERSION XXVII');
...
SELECT setval('"public"."archivos_id_archivo_seq"', 59, true);
...
SELECT setval('"public"."especialidades_id_especialidad_seq"', 31, true);
...
SELECT setval('"public"."metadatos_id_metadato_seq"', 58, true);
...
-- Alter sequences owned by
-- ----------------------------
ALTER SEQUENCE "public"."ubicaciones_id_ubicacion_seq"
OWNED BY "public"."ubicaciones"."id_ubicacion";
SELECT setval('"public"."ubicaciones_id_ubicacion_seq"', 2, false);
...
SELECT setval('"public"."usuarios_id_usuario_seq"', 14, true);
...
SELECT setval('"public"."ver_esp_id_ver_esp_seq"', 31, true);
...
-- ----------------------------
-- Primary Key structure for table ubicaciones
-- ----------------------------
ALTER TABLE "public"."ubicaciones" ADD CONSTRAINT "ubicaciones_pkey" PRIMARY KEY ("id_ubicacion");
...
ALTER TABLE "public"."metadatos" ADD CONSTRAINT "metadatos_id_ubicacion_fkey" FOREIGN KEY ("id_ubicacion") REFERENCES "public"."ubicaciones" ("id_ubicacion") ON DELETE NO ACTION ON UPDATE CASCADE;
