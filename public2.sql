...
SELECT setval('"public"."archivos_id_archivo_seq"', 29, true);
...
SELECT setval('"public"."especialidades_id_especialidad_seq"', 14, true);
...
SELECT setval('"public"."metadatos_id_metadato_seq"', 29, true);
...
SELECT setval('"public"."ver_esp_id_ver_esp_seq"', 14, true);
